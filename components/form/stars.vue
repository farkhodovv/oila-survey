<template>
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="stars">
          <div class="stars__header d-flex justify-content-center">
            <h5>So‘rovnomamizga baho bering</h5>
          </div>
          <div class="rating">
            <input type="radio" @click="feedbackStars.feedbackStars = 5" :checked="feedbackStars.feedbackStars === 5"
                   name="rating" id="rating-5">
            <label for="rating-5"></label>
            <input type="radio" @click="feedbackStars.feedbackStars = 4" :checked="feedbackStars.feedbackStars === 4"
                   name="rating" id="rating-4">
            <label for="rating-4"></label>
            <input type="radio" @click="feedbackStars.feedbackStars = 3" :checked="feedbackStars.feedbackStars === 3"
                   name="rating" id="rating-3">
            <label for="rating-3"></label>
            <input type="radio" @click="feedbackStars.feedbackStars = 2" :checked="feedbackStars.feedbackStars === 2"
                   name="rating" id="rating-2">
            <label for="rating-2"></label>
            <input type="radio" @click="feedbackStars.feedbackStars = 1" :checked="feedbackStars.feedbackStars === 1"
          ...
          <div class="stars__body">
            <p class="mt-3">This brief will help us get ready for the job so that we can do it the best for you.</p>
            <p class="mt-y">It depends on how clearly and comprehensively you answer the questions, how quickly we start
              speaking the
              same language in order to solve the tasks as quickly and efficiently as possible.</p>
          </div>
          <div class="stars__footer d-flex justify-content-center">
            <button class="btn-blue">Yakunlash</button>
          </div>
        </div>
      </div>
    </div>
