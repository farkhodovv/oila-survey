<template>
  <div class="stars">
    ...
    <div class="rating">
      <input type="radio" @click="feedbackStars = 5" :checked="feedbackStars === 5"
             name="rating" id="rating-5">
      <label for="rating-5"></label>
      <input type="radio" @click="feedbackStars = 4" :checked="feedbackStars === 4"
             name="rating" id="rating-4">
      <label for="rating-4"></label>
      <input type="radio" @click="feedbackStars = 3" :checked="feedbackStars === 3"
             name="rating" id="rating-3">
      <label for="rating-3"></label>
      <input type="radio" @click="feedbackStars = 2" :checked="feedbackStars === 2"
             name="rating" id="rating-2">
      <label for="rating-2"></label>
      <input type="radio" @click="feedbackStars = 1" :checked="feedbackStars === 1"
    ...
    <div class="stars__body">
      ...
      <p class="mt-3">It depends on how clearly and comprehensively you answer the questions, how quickly we start
        speaking the
    ...
    <div class="stars__footer d-flex justify-content-center">
      <button class="btn-blue" @click="rating">Yakunlash</button>
    </div>
  </div>
</template>
<script>
  ...
  export default {
    ...
    methods: {
      async rating() {
        ...
        const data = {
          survey: 1,
          rate_number: this.feedbackStars
        }
        await this.$axios.post(`survey/rate/`, data, {
          headers: {
